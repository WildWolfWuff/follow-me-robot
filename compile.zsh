...
ros2 launch follow_me_robot robot.launch.py start_sim:=true use_rviz:=false use_foxglove:=true start_sensors:=true start_nav:=true spawn_mock_bot:=true verbose:=true use_gui:=true world:=$world_path world_models:=$world_models bot_x:=-1 bot_y:=2